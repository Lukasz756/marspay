...
public class IdempotencyService {
    ...
    public IdempotencyResult execute(
        ...
        Optional<IdempotencyRecord> existingRecord =
                repository.findByScopeAndIdempotencyKey(
                        scope,
                        normalizedKey
                );
    ...
    public IdempotencyResult replayExisting(
            IdempotencyScope scope,
            String idempotencyKey,
            String requestHash
    ) {
        ...
        IdempotencyRecord record = repository
                ...
                .orElseThrow(() -> new IllegalStateException(
                        "Idempotency record was not found after "
    ...
    private IdempotencyResult replay(
